...
namespace Employee_Payee_Tax_Calculator_MVC.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(Employee_Payee_Tax_Calculator_DBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyName,Website")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
